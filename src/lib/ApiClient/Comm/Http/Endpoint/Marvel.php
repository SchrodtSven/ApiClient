 ...
 * 
 * 
 * @deprecated -> see:  SchrodtSven\ApiClient\App\Provider\Marvel
 * 
 * 
 * 
 * @package ApiClient
...
namespace SchrodtSven\ApiClient\Comm\Http\Endpoint;
...
class  Marvel
{
    ...
    public function __construct( private string $privateKey = '4ea332555596e42b08b693f09cfee311d0164c32', private string $publicKey = 'b66b7896c2cb68dab0f65627c2bf6394')
    {
        
    }

    /**
     * Generate query string part for authentication
     * 
     * <code>
     *  apikey={YOUR_PUBLIC_KEY}&hash={YOUR_HASH}&ts={CURRENT_TIMESTAMP}
     * </code>
     * 
     * @return string
     */
    public function getFullAuthQuery(): string
    {
        $ts = time();
